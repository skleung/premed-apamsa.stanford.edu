...
$(document).ready(function($) { 
	var added = ["spencer", "jasonkh","jessica","sherman", "cheylene", "stephen","catherine"];
	...
	var text = [stephenText, spencerText, "steven says...",jasonKhooText, "jason says...",shermanText,"phuong says...",jessicaText,cheyleneText,catherineText]
	function swap(i){
		swapHelper(names,i);
